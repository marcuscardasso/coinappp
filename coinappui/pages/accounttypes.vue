    ...
    <div class="accounttypes">
      ...
      <div class="accounttypes__main">
        <div class="accounttypes__main--top">
            ...
            <p>At TrustexGroup, we offer several different account types, each with specific benefits.</p>
        ...
        <div class="accounttypes__main--bottom">
          ...
          <h4>Silver</h4>
          <div class="accounttypes__plan--section">FREE Demo Account</div>
          <div class="accounttypes__plan--section">Min spread from 1.5 pips</div>
          <div class="accounttypes__plan--section">Max leverage up to 1:200</div>
          ...
          <div class="accounttypes__plan--section">
